...
def handle_keys():
    ...
    #=Ex3= Zoom e rotação eixo X e Y (aplicado globalmente na cena)
    ...
    #=Ex4= Teclas específicas para cada modo de interação
    #=Ex5= Cada opção funciona de forma independente
    ...
    if objeto_atual == 1:
        ...
        #=Ex6= Controle individual de cada objeto
        # Cubo: I, K, J, L
...
def draw_scene():
    ...
    #=Ex2= Renderiza os objetos com base na opção
    if objeto_atual == 1:
        draw_cube()
    elif objeto_atual == 2:
        draw_triangle()
